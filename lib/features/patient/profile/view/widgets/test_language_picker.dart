...
class CustomLanguagePickerDialog extends StatefulWidget {
  ...
  final ValueChanged<AppLanguage>? onValuePicked;
...
class SingleChoiceDialogState extends State<CustomLanguagePickerDialog> {
  late List<AppLanguage> _allLanguages;
  late List<AppLanguage> _filteredLanguages;

  @override
  void initState() {
    _allLanguages = widget.languages ?? CustomLanguages.defaultLanguages;
  ...
  return TextField(
    ...
    onChanged: (String value) {
      setState(() {
        _filteredLanguages = _allLanguages.where((AppLanguage language) {
...
typedef ItemBuilder = Widget Function(AppLanguage language);
