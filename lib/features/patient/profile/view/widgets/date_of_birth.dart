...
class SetDateOfBirth extends StatelessWidget {
  ...
  PatientProfileController patientProfileController = Get.find();
    ...
    return GestureDetector(
                      ...
                      SizedBox(
                        ...
                        child: CupertinoTheme(
                          ...
                          child: CupertinoDatePicker(
                            initialDateTime:
                                patientProfileController.patientBirthDay ??
                                    DateTime(2000, 1, 1),
                        ...
                        children: [
                          ...
                          ButtonWidget(
                            onPressed: () {
                              patientProfileController.patientBirthDay =
                                  selectedDate;
                              patientProfileController.update();
                              Get.back();
                            },
                            text: tr("Done"),
                            options: ButtonOptions(
      ...
      child: Container(
        ...
        child: GetBuilder<PatientProfileController>(builder: (context) {
          return Text(
            patientProfileController.patientBirthDay == null
                ? ''
                : DateFormat('yyyy-MM-dd',
                        Get.locale == const Locale('en') ? "en" : 'ar')
                    .format(patientProfileController.patientBirthDay!),
