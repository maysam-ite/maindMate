        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(child: Image.asset('assets/images/logo.png', width: 150.w, height: 150.h)),
              ...
              Row(
                ...
                children: [
                  Text(
                    'login',
                    style: appTheme.text18.copyWith(fontWeight: FontWeight.normal, fontSize: 32.sp, color: appTheme.primary),
                  ).tr(),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Text(
                      'login',
                      style: appTheme.text18.copyWith(fontWeight: FontWeight.w500, color: appTheme.primary),
                    ).tr(),
                  ),
                ],
              ),
