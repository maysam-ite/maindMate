...
class SelectGenderItem extends StatelessWidget {
  const SelectGenderItem(
      {super.key, required this.imagePath, required this.title,required this.isSelected,required this.onTap});
        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected?appTheme.primary:appTheme.primaryBackground,
                borderRadius: BorderRadius.circular(50),
                border: Border.all(color: appTheme.accent1, width: 1)),
            padding: const EdgeInsets.all(10),
            child: imagePath == '' ? const SizedBox() : Image.asset(imagePath,color:isSelected?appTheme.primaryBackground:appTheme.secondary),
          ),
        ),
        SizedBox(
          height: 20,
