  ...
  Widget _buildSessionTimeDetailes() {
    return Column(
      children: [
        ...
        Row(
          children: [
            Image.asset('assets/images/whatsapp.png',height: 15.h,),
            Image.asset('assets/images/telegram.png',height: 15.h),
            Image.asset('assets/images/googlemeet.png',height: 15.h),
            Image.asset('assets/images/zoom.png',height: 15.h),
            const Spacer(),
            Text(
              'الدخول',
