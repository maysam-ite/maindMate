...
class UpdateAndDeleteExistExperience extends StatefulWidget {
  UpdateAndDeleteExistExperience({
    Key? key,
  ...
  final Function(String title, String experienceFrom, DateTime startDate,
      DateTime endDate) onUpdate;
  final Function onDelete;

  @override
  State<UpdateAndDeleteExistExperience> createState() =>
      _UpdateAndDeleteExistExperienceState();
}

class _UpdateAndDeleteExistExperienceState
    extends State<UpdateAndDeleteExistExperience> {
  ...
  void initState() {
    super.initState();
    experienceTitle.text = widget.experience.title;
    experienceFrom.text = widget.experience.from;
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      ...
                      child: Text("update_experience", style: appTheme.text12)
                          .tr(),
                    ),
                  ),
                  Padding(
